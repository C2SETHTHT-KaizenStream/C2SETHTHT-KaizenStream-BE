...
public class DonationController {
    ...
    @PostMapping("/donate2")
    public ResponseEntity<String> testDonate(@RequestParam String streamerId) {
        donationService.testdonate(streamerId);

        return ResponseEntity.ok("Donation sent to user: " + streamerId);
    }
